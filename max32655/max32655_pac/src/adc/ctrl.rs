...
pub type PWR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, O>;
#[doc = "Field `refbuf_pwr` reader - ADC Reference Buffer Power Up"]
pub type REFBUF_PWR_R = crate::BitReader<bool>;
#[doc = "Field `refbuf_pwr` writer - ADC Reference Buffer Power Up"]
pub type REFBUF_PWR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, O>;
#[doc = "Field `ref_sel` reader - ADC Reference Select"]
pub type REF_SEL_R = crate::BitReader<bool>;
#[doc = "Field `ref_sel` writer - ADC Reference Select"]
pub type REF_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, O>;
#[doc = "Field `ref_scale` reader - ADC Reference Scale"]
pub type REF_SCALE_R = crate::BitReader<bool>;
#[doc = "Field `ref_scale` writer - ADC Reference Scale"]
pub type REF_SCALE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, O>;
#[doc = "Field `scale` reader - ADC Scale"]
pub type SCALE_R = crate::BitReader<bool>;
#[doc = "Field `scale` writer - ADC Scale"]
pub type SCALE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, O>;
...
pub type CH_SEL_R = crate::FieldReader<u8, CH_SEL_A>;
...
impl CH_SEL_R {
    ...
    #[doc = "Checks if the value of the field is `VCORE_A`"]
    #[inline(always)]
    pub fn is_vcore_a(&self) -> bool {
        *self == CH_SEL_A::VCORE_A
    }
    #[doc = "Checks if the value of the field is `VCORE_B`"]
    #[inline(always)]
    pub fn is_vcore_b(&self) -> bool {
        *self == CH_SEL_A::VCORE_B
    }
    #[doc = "Checks if the value of the field is `VRXOUT`"]
    #[inline(always)]
    pub fn is_vrxout(&self) -> bool {
        *self == CH_SEL_A::VRXOUT
    }
    #[doc = "Checks if the value of the field is `VTXOUT`"]
    #[inline(always)]
    pub fn is_vtxout(&self) -> bool {
        *self == CH_SEL_A::VTXOUT
    }
    #[doc = "Checks if the value of the field is `VDD_A`"]
    #[inline(always)]
    pub fn is_vdd_a(&self) -> bool {
        *self == CH_SEL_A::VDD_A
    }
    #[doc = "Checks if the value of the field is `VDD_B`"]
    #[inline(always)]
    ...
    #[doc = "Checks if the value of the field is `VDDIOH`"]
    #[inline(always)]
    pub fn is_vddioh(&self) -> bool {
        *self == CH_SEL_A::VDDIOH
    }
    #[doc = "Checks if the value of the field is `VREG_I`"]
    #[inline(always)]
...
pub type CH_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTRL_SPEC, u8, CH_SEL_A, 5, O>;
impl<'a, const O: u8> CH_SEL_W<'a, O> {
    #[doc = "`0`"]
    #[inline(always)]
    ...
    #[doc = "`1000`"]
    #[inline(always)]
    pub fn vcore_a(self) -> &'a mut W {
        self.variant(CH_SEL_A::VCORE_A)
    }
    #[doc = "`1001`"]
    #[inline(always)]
    pub fn vcore_b(self) -> &'a mut W {
        self.variant(CH_SEL_A::VCORE_B)
    }
    #[doc = "`1010`"]
    #[inline(always)]
    pub fn vrxout(self) -> &'a mut W {
        self.variant(CH_SEL_A::VRXOUT)
    }
    #[doc = "`1011`"]
    #[inline(always)]
    pub fn vtxout(self) -> &'a mut W {
        self.variant(CH_SEL_A::VTXOUT)
    }
    #[doc = "`1100`"]
    #[inline(always)]
    pub fn vdd_a(self) -> &'a mut W {
        self.variant(CH_SEL_A::VDD_A)
    }
    #[doc = "VddB/4"]
    #[inline(always)]
    pub fn vdd_b(self) -> &'a mut W {
...
pub type ADC_DIVSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CTRL_SPEC, u8, ADC_DIVSEL_A, 2, O>;
impl<'a, const O: u8> ADC_DIVSEL_W<'a, O> {
    #[doc = "`0`"]
    #[inline(always)]
...
pub type DATA_ALIGN_R = crate::BitReader<bool>;
#[doc = "Field `data_align` writer - ADC Data Alignment Select"]
pub type DATA_ALIGN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn refbuf_pwr(&mut self) -> REFBUF_PWR_W<3> {
        REFBUF_PWR_W::new(self)
    }
    #[doc = "Bit 4 - ADC Reference Select"]
    #[inline(always)]
    #[must_use]
    pub fn ref_sel(&mut self) -> REF_SEL_W<4> {
        REF_SEL_W::new(self)
    }
    #[doc = "Bit 8 - ADC Reference Scale"]
    #[inline(always)]
    #[must_use]
    pub fn ref_scale(&mut self) -> REF_SCALE_W<8> {
        REF_SCALE_W::new(self)
    }
    #[doc = "Bit 9 - ADC Scale"]
    #[inline(always)]
    #[must_use]
    pub fn scale(&mut self) -> SCALE_W<9> {
        SCALE_W::new(self)
    }
    #[doc = "Bit 11 - ADC Clock Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch_sel(&mut self) -> CH_SEL_W<12> {
        CH_SEL_W::new(self)
    }
    #[doc = "Bits 17:18 - Scales the external inputs, all inputs are scaled the same"]
    #[inline(always)]
    #[must_use]
    pub fn adc_divsel(&mut self) -> ADC_DIVSEL_W<17> {
        ADC_DIVSEL_W::new(self)
    }
    #[doc = "Bit 20 - ADC Data Alignment Select"]
    #[inline(always)]
    #[must_use]
    pub fn data_align(&mut self) -> DATA_ALIGN_W<20> {
