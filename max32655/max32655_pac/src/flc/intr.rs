...
pub type DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_SPEC, DONE_A, O>;
...
pub type AF_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_SPEC, AF_A, O>;
...
pub type DONEIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_SPEC, DONEIE_A, O>;
impl<'a, const O: u8> DONEIE_W<'a, O> {
    #[doc = "Disable."]
    #[inline(always)]
...
pub type AFIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_SPEC, AFIE_A, O>;
impl<'a, const O: u8> AFIE_W<'a, O> {
    #[doc = "Disable."]
    #[inline(always)]
    pub fn disable(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn af(&mut self) -> AF_W<1> {
        AF_W::new(self)
    }
    #[doc = "Bit 8 - Flash Done Interrupt Enable."]
    #[inline(always)]
    #[must_use]
    pub fn doneie(&mut self) -> DONEIE_W<8> {
        DONEIE_W::new(self)
    }
    #[doc = "Bit 9 - Flash Done Interrupt Enable."]
    #[inline(always)]
    #[must_use]
    pub fn afie(&mut self) -> AFIE_W<9> {
        AFIE_W::new(self)
    }
