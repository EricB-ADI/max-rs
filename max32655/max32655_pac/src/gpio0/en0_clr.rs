...
pub struct R(crate::R<EN0_CLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EN0_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EN0_CLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EN0_CLR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EN0_CLR` writer"]
pub struct W(crate::W<EN0_CLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EN0_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EN0_CLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EN0_CLR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ALL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EN0_CLR_SPEC, u32, u32, 32, O>;
impl R {
