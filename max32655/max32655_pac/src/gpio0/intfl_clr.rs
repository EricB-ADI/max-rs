...
pub struct R(crate::R<INTFL_CLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<INTFL_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<INTFL_CLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<INTFL_CLR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `INTFL_CLR` writer"]
pub struct W(crate::W<INTFL_CLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<INTFL_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<INTFL_CLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<INTFL_CLR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ALL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, INTFL_CLR_SPEC, u32, u32, 32, O>;
impl R {
