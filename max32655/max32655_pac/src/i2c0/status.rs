...
pub type TX_EM_W<'a, const O: u8> = crate::BitWriter<'a, u32, STATUS_SPEC, TX_EM_A, O>;
...
pub type TX_FULL_W<'a, const O: u8> = crate::BitWriter<'a, u32, STATUS_SPEC, TX_FULL_A, O>;
impl<'a, const O: u8> TX_FULL_W<'a, O> {
    #[doc = "Not Empty."]
    #[inline(always)]
    pub fn not_empty(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tx_em(&mut self) -> TX_EM_W<3> {
        TX_EM_W::new(self)
    }
    #[doc = "Bit 4 - TX Full."]
    #[inline(always)]
    #[must_use]
    pub fn tx_full(&mut self) -> TX_FULL_W<4> {
        TX_FULL_W::new(self)
    }
