...
pub struct R(crate::R<CMP_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CMP_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CMP_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CMP_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CMP_CTRL` writer"]
pub struct W(crate::W<CMP_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CMP_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CMP_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CMP_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type OUT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMP_CTRL_SPEC, bool, O>;
#[doc = "Field `INT_FL` reader - IRQ Flag"]
pub type INT_FL_R = crate::BitReader<bool>;
#[doc = "Field `INT_FL` writer - IRQ Flag"]
pub type INT_FL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMP_CTRL_SPEC, bool, O>;
impl R {
