...
pub type LONG_LINE_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG_SPEC, bool, O>;
...
pub type FORCE_PRES_DET_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG_SPEC, bool, O>;
...
pub type BIT_BANG_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG_SPEC, bool, O>;
...
pub type EXT_PULLUP_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG_SPEC, bool, O>;
...
pub type EXT_PULLUP_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG_SPEC, bool, O>;
...
pub type SINGLE_BIT_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG_SPEC, bool, O>;
...
pub type OVERDRIVE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG_SPEC, bool, O>;
...
pub type INT_PULLUP_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn long_line_mode(&mut self) -> LONG_LINE_MODE_W<0> {
        LONG_LINE_MODE_W::new(self)
    }
    #[doc = "Bit 1 - Force Line During Presence Detect."]
    #[inline(always)]
    #[must_use]
    pub fn force_pres_det(&mut self) -> FORCE_PRES_DET_W<1> {
        FORCE_PRES_DET_W::new(self)
    }
    #[doc = "Bit 2 - Bit Bang Enable."]
    #[inline(always)]
    #[must_use]
    pub fn bit_bang_en(&mut self) -> BIT_BANG_EN_W<2> {
        BIT_BANG_EN_W::new(self)
    }
    #[doc = "Bit 3 - Provide an extra output control to control an external pullup."]
    #[inline(always)]
    #[must_use]
    pub fn ext_pullup_mode(&mut self) -> EXT_PULLUP_MODE_W<3> {
        EXT_PULLUP_MODE_W::new(self)
    }
    #[doc = "Bit 4 - Enable External Pullup."]
    #[inline(always)]
    #[must_use]
    pub fn ext_pullup_enable(&mut self) -> EXT_PULLUP_ENABLE_W<4> {
        EXT_PULLUP_ENABLE_W::new(self)
    }
    #[doc = "Bit 5 - Enable Single Bit TX/RX Mode."]
    #[inline(always)]
    #[must_use]
    pub fn single_bit_mode(&mut self) -> SINGLE_BIT_MODE_W<5> {
        SINGLE_BIT_MODE_W::new(self)
    }
    #[doc = "Bit 6 - Enables overdrive speed for 1-Wire operations."]
    #[inline(always)]
    #[must_use]
    pub fn overdrive(&mut self) -> OVERDRIVE_W<6> {
        OVERDRIVE_W::new(self)
    }
    #[doc = "Bit 7 - Enable intenral pullup."]
    #[inline(always)]
    #[must_use]
    pub fn int_pullup_enable(&mut self) -> INT_PULLUP_ENABLE_W<7> {
