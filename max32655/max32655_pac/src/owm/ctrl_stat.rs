...
pub type START_OW_RESET_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_STAT_SPEC, bool, O>;
#[doc = "Field `sra_mode` reader - SRA Mode."]
pub type SRA_MODE_R = crate::BitReader<bool>;
#[doc = "Field `sra_mode` writer - SRA Mode."]
pub type SRA_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_STAT_SPEC, bool, O>;
...
pub type BIT_BANG_OE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_STAT_SPEC, bool, O>;
...
pub type OD_SPEC_MODE_R = crate::BitReader<bool>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn start_ow_reset(&mut self) -> START_OW_RESET_W<0> {
        START_OW_RESET_W::new(self)
    }
    #[doc = "Bit 1 - SRA Mode."]
    #[inline(always)]
    #[must_use]
    pub fn sra_mode(&mut self) -> SRA_MODE_W<1> {
        SRA_MODE_W::new(self)
    }
    #[doc = "Bit 2 - Bit Bang Output Enable."]
    #[inline(always)]
    #[must_use]
    pub fn bit_bang_oe(&mut self) -> BIT_BANG_OE_W<2> {
