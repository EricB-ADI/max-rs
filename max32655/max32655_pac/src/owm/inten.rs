...
pub type OW_RESET_DONE_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, INTEN_SPEC, bool, O>;
...
pub type TX_DATA_EMPTY_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, INTEN_SPEC, bool, O>;
...
pub type RX_DATA_READY_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, INTEN_SPEC, bool, O>;
...
pub type LINE_SHORT_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, INTEN_SPEC, bool, O>;
...
pub type LINE_LOW_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, INTEN_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ow_reset_done(&mut self) -> OW_RESET_DONE_W<0> {
        OW_RESET_DONE_W::new(self)
    }
    #[doc = "Bit 1 - Tx Data Empty Interrupt Enable."]
    #[inline(always)]
    #[must_use]
    pub fn tx_data_empty(&mut self) -> TX_DATA_EMPTY_W<1> {
        TX_DATA_EMPTY_W::new(self)
    }
    #[doc = "Bit 2 - Rx Data Ready Interrupt Enable."]
    #[inline(always)]
    #[must_use]
    pub fn rx_data_ready(&mut self) -> RX_DATA_READY_W<2> {
        RX_DATA_READY_W::new(self)
    }
    #[doc = "Bit 3 - OW Line Short Detected Interrupt Enable."]
    #[inline(always)]
    #[must_use]
    pub fn line_short(&mut self) -> LINE_SHORT_W<3> {
        LINE_SHORT_W::new(self)
    }
    #[doc = "Bit 4 - OW Line Low Detected Interrupt Enable."]
    #[inline(always)]
    #[must_use]
    pub fn line_low(&mut self) -> LINE_LOW_W<4> {
        LINE_LOW_W::new(self)
    }
