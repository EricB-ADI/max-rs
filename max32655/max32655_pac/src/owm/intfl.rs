...
pub type OW_RESET_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTFL_SPEC, bool, O>;
...
pub type TX_DATA_EMPTY_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTFL_SPEC, bool, O>;
...
pub type RX_DATA_READY_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTFL_SPEC, bool, O>;
...
pub type LINE_SHORT_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTFL_SPEC, bool, O>;
...
pub type LINE_LOW_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTFL_SPEC, bool, O>;
impl R {
