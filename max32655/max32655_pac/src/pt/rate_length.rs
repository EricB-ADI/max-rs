...
pub type RATE_CONTROL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RATE_LENGTH_SPEC, u32, u32, 27, O>;
...
pub type MODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, RATE_LENGTH_SPEC, u8, MODE_A, 5, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rate_control(&mut self) -> RATE_CONTROL_W<0> {
        RATE_CONTROL_W::new(self)
    }
    #[doc = "Bits 27:31 - Pulse Train Output Mode/Train Length"]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> MODE_W<27> {
        MODE_W::new(self)
    }
