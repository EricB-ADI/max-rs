...
pub struct R(crate::R<LPPWEN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LPPWEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LPPWEN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LPPWEN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `LPPWEN` writer"]
pub struct W(crate::W<LPPWEN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LPPWEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LPPWEN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LPPWEN_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UART0_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPPWEN_SPEC, bool, O>;
...
pub type UART1_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPPWEN_SPEC, bool, O>;
...
pub type UART2_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPPWEN_SPEC, bool, O>;
...
pub type UART3_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPPWEN_SPEC, bool, O>;
...
pub type I2C0_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPPWEN_SPEC, bool, O>;
...
pub type I2C1_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPPWEN_SPEC, bool, O>;
...
pub type I2C2_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPPWEN_SPEC, bool, O>;
...
pub type I2S_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPPWEN_SPEC, bool, O>;
...
pub type SPI1_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPPWEN_SPEC, bool, O>;
#[doc = "Field `LPCMP` reader - LPCMP Wakeup Enable. This bit allows wakeup from the LPCMP."]
pub type LPCMP_R = crate::BitReader<bool>;
#[doc = "Field `LPCMP` writer - LPCMP Wakeup Enable. This bit allows wakeup from the LPCMP."]
pub type LPCMP_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPPWEN_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wdt0(&mut self) -> WDT0_W<8> {
        WDT0_W::new(self)
    }
    #[doc = "Bit 9 - WDT1 Wakeup Enable. This bit allows wakeup from the WDT1."]
    #[inline(always)]
    #[must_use]
    pub fn wdt1(&mut self) -> WDT1_W<9> {
        WDT1_W::new(self)
    }
    #[doc = "Bit 10 - CPU1 Wakeup Enable. This bit allows wakeup from the CPU1."]
    #[inline(always)]
    #[must_use]
    pub fn cpu1(&mut self) -> CPU1_W<10> {
        CPU1_W::new(self)
    }
    #[doc = "Bit 11 - TMR0 Wakeup Enable. This bit allows wakeup from the TMR0."]
    #[inline(always)]
    #[must_use]
    pub fn tmr0(&mut self) -> TMR0_W<11> {
        TMR0_W::new(self)
    }
    #[doc = "Bit 12 - TMR1 Wakeup Enable. This bit allows wakeup from the TMR1."]
    #[inline(always)]
    #[must_use]
    pub fn tmr1(&mut self) -> TMR1_W<12> {
        TMR1_W::new(self)
    }
    #[doc = "Bit 13 - TMR2 Wakeup Enable. This bit allows wakeup from the TMR2."]
    #[inline(always)]
    #[must_use]
    pub fn tmr2(&mut self) -> TMR2_W<13> {
        TMR2_W::new(self)
    }
    #[doc = "Bit 14 - TMR3 Wakeup Enable. This bit allows wakeup from the TMR3."]
    #[inline(always)]
    #[must_use]
    pub fn tmr3(&mut self) -> TMR3_W<14> {
        TMR3_W::new(self)
    }
    #[doc = "Bit 15 - TMR4 Wakeup Enable. This bit allows wakeup from the TMR4."]
    #[inline(always)]
    #[must_use]
    pub fn tmr4(&mut self) -> TMR4_W<15> {
        TMR4_W::new(self)
    }
    #[doc = "Bit 16 - TMR5 Wakeup Enable. This bit allows wakeup from the TMR5."]
    #[inline(always)]
    #[must_use]
    pub fn tmr5(&mut self) -> TMR5_W<16> {
        TMR5_W::new(self)
    }
    #[doc = "Bit 17 - UART0 Wakeup Enable. This bit allows wakeup from the UART0."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn uart2(&mut self) -> UART2_W<19> {
        UART2_W::new(self)
    }
    #[doc = "Bit 20 - UART3 Wakeup Enable. This bit allows wakeup from the UART3."]
    #[inline(always)]
    #[must_use]
    pub fn uart3(&mut self) -> UART3_W<20> {
        UART3_W::new(self)
    }
    #[doc = "Bit 21 - I2C0 Wakeup Enable. This bit allows wakeup from the I2C0."]
    #[inline(always)]
    #[must_use]
    pub fn i2c0(&mut self) -> I2C0_W<21> {
        I2C0_W::new(self)
    }
    #[doc = "Bit 22 - I2C1 Wakeup Enable. This bit allows wakeup from the I2C1."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c2(&mut self) -> I2C2_W<23> {
        I2C2_W::new(self)
    }
    #[doc = "Bit 24 - I2S Wakeup Enable. This bit allows wakeup from the I2S."]
    #[inline(always)]
    #[must_use]
    pub fn i2s(&mut self) -> I2S_W<24> {
        I2S_W::new(self)
    }
    #[doc = "Bit 25 - SPI1 Wakeup Enable. This bit allows wakeup from the SPI1."]
    #[inline(always)]
    #[must_use]
    pub fn spi1(&mut self) -> SPI1_W<25> {
        SPI1_W::new(self)
    }
    #[doc = "Bit 26 - LPCMP Wakeup Enable. This bit allows wakeup from the LPCMP."]
    #[inline(always)]
    #[must_use]
    pub fn lpcmp(&mut self) -> LPCMP_W<26> {
        LPCMP_W::new(self)
    }
