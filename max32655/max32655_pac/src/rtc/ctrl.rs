...
pub type TOD_ALARM_IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, TOD_ALARM_IE_A, O>;
impl<'a, const O: u8> TOD_ALARM_IE_W<'a, O> {
    #[doc = "Disable."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
...
pub type SSEC_ALARM_IE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CTRL_SPEC, SSEC_ALARM_IE_A, O>;
impl<'a, const O: u8> SSEC_ALARM_IE_W<'a, O> {
    #[doc = "Disable."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
...
pub type RDY_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, RDY_A, O>;
...
pub type RDY_IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, RDY_IE_A, O>;
impl<'a, const O: u8> RDY_IE_W<'a, O> {
    #[doc = "Disable."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
...
pub type SQW_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, SQW_EN_A, O>;
impl<'a, const O: u8> SQW_EN_W<'a, O> {
    #[doc = "Not active"]
    #[inline(always)]
...
pub type SQW_SEL_R = crate::FieldReader<u8, SQW_SEL_A>;
...
pub type SQW_SEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CTRL_SPEC, u8, SQW_SEL_A, 2, O>;
impl<'a, const O: u8> SQW_SEL_W<'a, O> {
...
pub type RD_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tod_alarm_ie(&mut self) -> TOD_ALARM_IE_W<1> {
        TOD_ALARM_IE_W::new(self)
    }
    #[doc = "Bit 2 - Alarm Sub-second Interrupt Enable. Change to this bit is effective only after BUSY is cleared from 1 to 0."]
    #[inline(always)]
    #[must_use]
    pub fn ssec_alarm_ie(&mut self) -> SSEC_ALARM_IE_W<2> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rdy_ie(&mut self) -> RDY_IE_W<5> {
        RDY_IE_W::new(self)
    }
    #[doc = "Bit 8 - Square Wave Output Enable."]
    #[inline(always)]
    #[must_use]
    pub fn sqw_en(&mut self) -> SQW_EN_W<8> {
        SQW_EN_W::new(self)
    }
    #[doc = "Bits 9:10 - Frequency Output Selection. When SQE=1, these bits specify the output frequency on the SQW pin."]
    #[inline(always)]
    #[must_use]
    pub fn sqw_sel(&mut self) -> SQW_SEL_W<9> {
        SQW_SEL_W::new(self)
    }
    #[doc = "Bit 14 - Asynchronous Counter Read Enable."]
    #[inline(always)]
    #[must_use]
    pub fn rd_en(&mut self) -> RD_EN_W<14> {
        RD_EN_W::new(self)
    }
    #[doc = "Bit 15 - Write Enable. This register bit serves as a protection mechanism against unintentional writes to critical RTC bits."]
    #[inline(always)]
    #[must_use]
    pub fn wr_en(&mut self) -> WR_EN_W<15> {
        WR_EN_W::new(self)
    }
