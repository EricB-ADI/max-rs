...
pub struct R(crate::R<BUCK_ALERT_THR_B_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BUCK_ALERT_THR_B_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BUCK_ALERT_THR_B_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BUCK_ALERT_THR_B_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `BUCK_ALERT_THR_B` writer"]
pub struct W(crate::W<BUCK_ALERT_THR_B_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<BUCK_ALERT_THR_B_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<BUCK_ALERT_THR_B_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<BUCK_ALERT_THR_B_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `BUCKTHRB` reader - Threshold for ILOADB to generate the BUCK_ALERT"]
pub type BUCKTHRB_R = crate::FieldReader<u8, u8>;
#[doc = "Field `BUCKTHRB` writer - Threshold for ILOADB to generate the BUCK_ALERT"]
pub type BUCKTHRB_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, BUCK_ALERT_THR_B_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn buckthrb(&mut self) -> BUCKTHRB_W<0> {
        BUCKTHRB_W::new(self)
    }
