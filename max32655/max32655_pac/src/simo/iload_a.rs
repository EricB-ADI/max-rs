...
pub struct R(crate::R<ILOAD_A_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ILOAD_A_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ILOAD_A_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ILOAD_A_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `ILOADA` reader - Number of buck cycles that occur within the cycle clock"]
pub type ILOADA_R = crate::FieldReader<u8, u8>;
impl R {
...
#[doc = "Buck Cycle Count VREGO_A Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [iload_a](index.html) module"]
