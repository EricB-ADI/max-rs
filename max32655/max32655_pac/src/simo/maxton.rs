...
pub struct R(crate::R<MAXTON_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MAXTON_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MAXTON_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MAXTON_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MAXTON` writer"]
pub struct W(crate::W<MAXTON_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MAXTON_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tonset(&mut self) -> TONSET_W<0> {
        TONSET_W::new(self)
    }
