...
pub type EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL0_SPEC, EN_A, O>;
...
pub type MST_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL0_SPEC, MST_MODE_A, O>;
...
pub type SS_IO_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL0_SPEC, SS_IO_A, O>;
impl<'a, const O: u8> SS_IO_W<'a, O> {
...
pub type START_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL0_SPEC, START_A, O>;
...
pub type SS_CTRL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL0_SPEC, SS_CTRL_A, O>;
impl<'a, const O: u8> SS_CTRL_W<'a, O> {
...
pub type SS_ACTIVE_R = crate::FieldReader<u8, SS_ACTIVE_A>;
...
pub type SS_ACTIVE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CTRL0_SPEC, u8, SS_ACTIVE_A, 4, O>;
impl<'a, const O: u8> SS_ACTIVE_W<'a, O> {
    #[doc = "SS0 is selected."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ss_io(&mut self) -> SS_IO_W<4> {
        SS_IO_W::new(self)
    }
    #[doc = "Bit 5 - Start Transmit."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ss_ctrl(&mut self) -> SS_CTRL_W<8> {
        SS_CTRL_W::new(self)
    }
    #[doc = "Bits 16:19 - Slave Select, when in Master mode selects which Slave devices are selected. More than one Slave device can be selected."]
    #[inline(always)]
    #[must_use]
    pub fn ss_active(&mut self) -> SS_ACTIVE_W<16> {
