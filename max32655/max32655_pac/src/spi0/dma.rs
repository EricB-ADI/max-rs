...
pub type TX_THD_VAL_R = crate::FieldReader<u8, u8>;
...
pub type TX_THD_VAL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_SPEC, u8, u8, 5, O>;
...
pub type TX_FIFO_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_SPEC, TX_FIFO_EN_A, O>;
impl<'a, const O: u8> TX_FIFO_EN_W<'a, O> {
...
pub type TX_FLUSH_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_SPEC, TX_FLUSH_A, O>;
impl<'a, const O: u8> TX_FLUSH_W<'a, O> {
...
pub type DMA_TX_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_SPEC, DMA_TX_EN_A, O>;
impl<'a, const O: u8> DMA_TX_EN_W<'a, O> {
...
pub type RX_THD_VAL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_SPEC, u8, u8, 5, O>;
...
pub type RX_FIFO_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_SPEC, RX_FIFO_EN_A, O>;
impl<'a, const O: u8> RX_FIFO_EN_W<'a, O> {
...
pub type RX_FLUSH_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_SPEC, RX_FLUSH_A, O>;
impl<'a, const O: u8> RX_FLUSH_W<'a, O> {
...
pub type DMA_RX_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_SPEC, DMA_RX_EN_A, O>;
impl<'a, const O: u8> DMA_RX_EN_W<'a, O> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tx_thd_val(&mut self) -> TX_THD_VAL_W<0> {
        TX_THD_VAL_W::new(self)
    }
    #[doc = "Bit 6 - Transmit FIFO enabled for SPI transactions."]
    #[inline(always)]
    #[must_use]
    pub fn tx_fifo_en(&mut self) -> TX_FIFO_EN_W<6> {
        TX_FIFO_EN_W::new(self)
    }
    #[doc = "Bit 7 - Clear TX FIFO, clear is accomplished by resetting the read and write pointers. This should be done when FIFO is not being accessed on the SPI side."]
    #[inline(always)]
    #[must_use]
    pub fn tx_flush(&mut self) -> TX_FLUSH_W<7> {
        TX_FLUSH_W::new(self)
    }
    #[doc = "Bit 15 - TX DMA Enable."]
    #[inline(always)]
    #[must_use]
    pub fn dma_tx_en(&mut self) -> DMA_TX_EN_W<15> {
        DMA_TX_EN_W::new(self)
    }
    #[doc = "Bits 16:20 - Receive FIFO level that will trigger a DMA request, also level for threshold status. When RX FIFO has more than this many bytes, the associated events and conditions are triggered."]
    #[inline(always)]
    #[must_use]
    pub fn rx_thd_val(&mut self) -> RX_THD_VAL_W<16> {
        RX_THD_VAL_W::new(self)
    }
    #[doc = "Bit 22 - Receive FIFO enabled for SPI transactions."]
    #[inline(always)]
    #[must_use]
    pub fn rx_fifo_en(&mut self) -> RX_FIFO_EN_W<22> {
        RX_FIFO_EN_W::new(self)
    }
    #[doc = "Bit 23 - Clear RX FIFO, clear is accomplished by resetting the read and write pointers. This should be done when FIFO is not being accessed on the SPI side."]
    #[inline(always)]
    #[must_use]
    pub fn rx_flush(&mut self) -> RX_FLUSH_W<23> {
        RX_FLUSH_W::new(self)
    }
    #[doc = "Bit 31 - RX DMA Enable."]
    #[inline(always)]
    #[must_use]
    pub fn dma_rx_en(&mut self) -> DMA_RX_EN_W<31> {
