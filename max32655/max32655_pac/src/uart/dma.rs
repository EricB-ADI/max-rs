...
pub type TX_THD_VAL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_SPEC, u8, u8, 4, O>;
...
pub type TX_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_SPEC, bool, O>;
...
pub type RX_THD_VAL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_SPEC, u8, u8, 4, O>;
...
pub type RX_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tx_en(&mut self) -> TX_EN_W<4> {
        TX_EN_W::new(self)
    }
    #[doc = "Bits 5:8 - Rx FIFO Level DMA Trigger If the RX FIFO level is greater than this value, then the RX FIFO DMA interface will send a signal to the system DMA to notify that RX FIFO has characters to transfer to memory."]
    #[inline(always)]
    #[must_use]
    pub fn rx_thd_val(&mut self) -> RX_THD_VAL_W<5> {
        RX_THD_VAL_W::new(self)
    }
    #[doc = "Bit 9 - RX DMA channel enable"]
    #[inline(always)]
    #[must_use]
    pub fn rx_en(&mut self) -> RX_EN_W<9> {
        RX_EN_W::new(self)
    }
