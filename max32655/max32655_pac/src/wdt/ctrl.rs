...
pub type INT_LATE_VAL_R = crate::FieldReader<u8, INT_LATE_VAL_A>;
...
pub type INT_LATE_VAL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CTRL_SPEC, u8, INT_LATE_VAL_A, 4, O>;
impl<'a, const O: u8> INT_LATE_VAL_W<'a, O> {
...
pub type RST_LATE_VAL_R = crate::FieldReader<u8, RST_LATE_VAL_A>;
...
pub type RST_LATE_VAL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CTRL_SPEC, u8, RST_LATE_VAL_A, 4, O>;
impl<'a, const O: u8> RST_LATE_VAL_W<'a, O> {
    #[doc = "2**31 clock cycles."]
    #[inline(always)]
    pub fn wdt2pow31(self) -> &'a mut W {
...
pub type INT_LATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, INT_LATE_A, O>;
impl<'a, const O: u8> INT_LATE_W<'a, O> {
...
pub type WDT_INT_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, WDT_INT_EN_A, O>;
impl<'a, const O: u8> WDT_INT_EN_W<'a, O> {
    #[doc = "Disable."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
...
pub type WDT_RST_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, WDT_RST_EN_A, O>;
impl<'a, const O: u8> WDT_RST_EN_W<'a, O> {
    #[doc = "Disable."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
...
pub type INT_EARLY_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, INT_EARLY_A, O>;
impl<'a, const O: u8> INT_EARLY_W<'a, O> {
    #[doc = "No interrupt is pending."]
    #[inline(always)]
    pub fn inactive(self) -> &'a mut W {
...
pub type INT_EARLY_VAL_R = crate::FieldReader<u8, INT_EARLY_VAL_A>;
...
pub type INT_EARLY_VAL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CTRL_SPEC, u8, INT_EARLY_VAL_A, 4, O>;
impl<'a, const O: u8> INT_EARLY_VAL_W<'a, O> {
    #[doc = "2**31 clock cycles."]
    #[inline(always)]
    pub fn wdt2pow31(self) -> &'a mut W {
...
pub type RST_EARLY_VAL_R = crate::FieldReader<u8, RST_EARLY_VAL_A>;
...
pub type RST_EARLY_VAL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CTRL_SPEC, u8, RST_EARLY_VAL_A, 4, O>;
impl<'a, const O: u8> RST_EARLY_VAL_W<'a, O> {
    #[doc = "2**31 clock cycles."]
    #[inline(always)]
    pub fn wdt2pow31(self) -> &'a mut W {
...
pub type WIN_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, WIN_EN_A, O>;
impl<'a, const O: u8> WIN_EN_W<'a, O> {
...
pub type RST_EARLY_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, RST_EARLY_A, O>;
impl<'a, const O: u8> RST_EARLY_W<'a, O> {
...
pub type RST_LATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, RST_LATE_A, O>;
impl<'a, const O: u8> RST_LATE_W<'a, O> {
    #[doc = "The event has not occurred."]
    #[inline(always)]
    pub fn no_event(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int_late_val(&mut self) -> INT_LATE_VAL_W<0> {
        INT_LATE_VAL_W::new(self)
    }
    #[doc = "Bits 4:7 - Windowed Watchdog Reset Upper Limit. Sets the number of WDTCLK cycles until a system reset occurs (if enabled) if the CPU does not write the watchdog reset sequence to the WDT_RST register before the watchdog timer has counted this time period since the last timer reset."]
    #[inline(always)]
    #[must_use]
    pub fn rst_late_val(&mut self) -> RST_LATE_VAL_W<4> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int_late(&mut self) -> INT_LATE_W<9> {
        INT_LATE_W::new(self)
    }
    #[doc = "Bit 10 - Windowed Watchdog Timer Interrupt Enable."]
    #[inline(always)]
    #[must_use]
    pub fn wdt_int_en(&mut self) -> WDT_INT_EN_W<10> {
        WDT_INT_EN_W::new(self)
    }
    #[doc = "Bit 11 - Windowed Watchdog Timer Reset Enable."]
    #[inline(always)]
    #[must_use]
    pub fn wdt_rst_en(&mut self) -> WDT_RST_EN_W<11> {
        WDT_RST_EN_W::new(self)
    }
    #[doc = "Bit 12 - Windowed Watchdog Timer Interrupt Flag Too Soon."]
    #[inline(always)]
    #[must_use]
    pub fn int_early(&mut self) -> INT_EARLY_W<12> {
        INT_EARLY_W::new(self)
    }
    #[doc = "Bits 16:19 - Windowed Watchdog Interrupt Lower Limit. Sets the number of WDTCLK cycles that establishes the lower boundary of the watchdog window. A windowed watchdog timer interrupt is generated (if enabled) if the CPU writes the windowed watchdog reset sequence to the WWDT_RST register before the watchdog timer has counted this time period since the last timer reset."]
    #[inline(always)]
    #[must_use]
    pub fn int_early_val(&mut self) -> INT_EARLY_VAL_W<16> {
        INT_EARLY_VAL_W::new(self)
    }
    #[doc = "Bits 20:23 - Windowed Watchdog Reset Lower Limit. Sets the number of WDTCLK cycles that establishes the lower boundary of the watchdog window. A system reset occurs (if enabled) if the CPU writes the windowed watchdog reset sequence to the WWDT_RST register before the watchdog timer has counted this time period since the last timer reset."]
    #[inline(always)]
    #[must_use]
    pub fn rst_early_val(&mut self) -> RST_EARLY_VAL_W<20> {
        RST_EARLY_VAL_W::new(self)
    }
    #[doc = "Bit 27 - Switch Ready Interrupt Enable. Fires an interrupt when it is safe to swithc the clock."]
    #[inline(always)]
    #[must_use]
    pub fn clkrdy_ie(&mut self) -> CLKRDY_IE_W<27> {
        CLKRDY_IE_W::new(self)
    }
    #[doc = "Bit 28 - Clock Status."]
    #[inline(always)]
    #[must_use]
    pub fn clkrdy(&mut self) -> CLKRDY_W<28> {
        CLKRDY_W::new(self)
    }
    #[doc = "Bit 29 - Enables the Windowed Watchdog Function."]
    #[inline(always)]
    #[must_use]
    pub fn win_en(&mut self) -> WIN_EN_W<29> {
        WIN_EN_W::new(self)
    }
    #[doc = "Bit 30 - Windowed Watchdog Timer Reset Flag Too Soon."]
    #[inline(always)]
    #[must_use]
    pub fn rst_early(&mut self) -> RST_EARLY_W<30> {
        RST_EARLY_W::new(self)
    }
    #[doc = "Bit 31 - Windowed Watchdog Timer Reset Flag Too Late."]
    #[inline(always)]
    #[must_use]
    pub fn rst_late(&mut self) -> RST_LATE_W<31> {
        RST_LATE_W::new(self)
    }
