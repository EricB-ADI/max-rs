...
impl TMODE_R {
    ...
    #[doc = "Checks if the value of the field is `CAPTURE_COMPARE`"]
    #[inline(always)]
...
pub type TMODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTRL_SPEC, u8, TMODE_A, 3, O>;
...
pub type PRES_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CTRL_SPEC, u8, PRES_A, 3, O>;
...
impl TPOL_R {
    ...
    #[doc = "Checks if the value of the field is `ACTIVE_HI`"]
    #[inline(always)]
    pub fn is_active_hi(&self) -> bool {
        *self == TPOL_A::ACTIVE_HI
    }
    #[doc = "Checks if the value of the field is `ACTIVE_LO`"]
    #[inline(always)]
...
pub type TPOL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, TPOL_A, O>;
impl<'a, const O: u8> TPOL_W<'a, O> {
    #[doc = "Active High."]
    #[inline(always)]
...
pub type TEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, TEN_A, O>;
...
pub type PRES3_R = crate::BitReader<bool>;
#[doc = "Field `PRES3` writer - MSB of prescaler value."]
pub type PRES3_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmode(&mut self) -> TMODE_W<0> {
        TMODE_W::new(self)
    }
    #[doc = "Bits 3:5 - Prescaler. Set the Timer's prescaler value. The prescaler divides the PCLK input to the timer and sets the Timer's Count Clock, F_CNT_CLK = PCLK(HZ)/prescaler. The Timer's prescaler setting is a 4-bit value with pres3:pres\\[2:0\\]."]
    #[inline(always)]
    #[must_use]
    pub fn pres(&mut self) -> PRES_W<3> {
        PRES_W::new(self)
    }
    #[doc = "Bit 6 - Timer input/output polarity bit."]
    #[inline(always)]
    #[must_use]
    pub fn tpol(&mut self) -> TPOL_W<6> {
        TPOL_W::new(self)
    }
    #[doc = "Bit 7 - Timer Enable."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pres3(&mut self) -> PRES3_W<8> {
        PRES3_W::new(self)
    }
